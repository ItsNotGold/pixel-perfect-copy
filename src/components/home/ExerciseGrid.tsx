          ...
          {exercises.map((exercise, index) => {
            ...
            return (
              <Link
                key={exercise.id}
                to={exercise.path}
                className="group relative overflow-hidden rounded-2xl glass p-6 transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1 animate-scale-in"
