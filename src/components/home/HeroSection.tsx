  ...
  return (
    <section className="relative overflow-hidden px-6 py-20 lg:py-32 bg-noise">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        {/* Headline */}
        <h1 className="mb-6 font-display text-4xl leading-tight text-foreground sm:text-5xl lg:text-6xl animate-primary">
          Transform Your{" "}
          <span className="paren-accent text-gradient">Communication Skills</span>
        </h1>

        {/* Subheadline */}
        <p className="mb-8 text-lg text-muted-foreground sm:text-xl animate-secondary" style={{ animationDelay: "0.08s" }}>
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row" style={{ animationDelay: "0.16s" }}>
          <Link to="/exercise/precision-swap">
            <Button variant="hero" size="xl" className="animate-micro">
              Start Training
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
          </Link>
          <Button variant="glass" size="xl" asChild className="animate-micro">
            <a href="#exercises">
              Browse Exercises
            </a>
          </Button>
        ...
        <div className="mt-12 grid grid-cols-3 gap-6">
          <div className="rounded-xl glass-strong glass-reflection p-4 animate-secondary" style={{ animationDelay: "0.2s" }}>
            <div className="font-display text-3xl text-primary">5</div>
            <div className="text-sm text-muted-foreground">Unique Exercises</div>
          </div>
          <div className="rounded-xl glass-strong glass-reflection p-4 animate-secondary" style={{ animationDelay: "0.28s" }}>
            <div className="font-display text-3xl text-primary">5min</div>
            <div className="text-sm text-muted-foreground">Daily Practice</div>
          </div>
          <div className="rounded-xl glass-strong glass-reflection p-4 animate-secondary" style={{ animationDelay: "0.36s" }}>
