...
import { generatePrecisionSwapQuestions } from "../generated/precisionSwapGenerator";
    ...
    content: {
        ...
        multilingual: {
            en: {
                ...
                questions: generatePrecisionSwapQuestions(90, "en")
            },
            fr: {
                instructions: {
                ...
                questions: generatePrecisionSwapQuestions(90, "fr")
            },
            es: {
                instructions: {
                ...
                questions: generatePrecisionSwapQuestions(90, "es")
            }
        }
    }
};
