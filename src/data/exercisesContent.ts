...
export const precisionSwap: Record<Language, any[]> = (raw as any).precisionSwap || { en: [] };
export const reverseDefinitions: Record<Language, any[]> = (raw as any).reverseDefinitions || { en: [] };
export const synonymChain: Record<Language, any[]> = (raw as any).synonymChain || { en: [] };
