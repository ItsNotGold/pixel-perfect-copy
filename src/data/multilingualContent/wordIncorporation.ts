...
export const wordIncorporationPrompts: Record<Language, WordIncorporationPrompt[]> = {
  ...
  es: [
    ...
    ,
    {
      prompt: "Habla sobre un libro reciente que disfrutaste",
    ...
    {
      prompt: "Comenta tu enfoque para aprender nuevas habilidades",
      words: ["práctica", "retroalimentación", "constancia", "recursos", "paciencia"]
    },
    {
      prompt: "Habla sobre una comida memorable",
    ...
    {
      prompt: "Comenta cómo gestionas tus finanzas",
      words: ["ahorro", "presupuesto", "inversión", "deuda", "metas"]
    },
    {
      prompt: "Habla de una tecnología que no puedes dejar de usar",
      words: ["dispositivo", "conectividad", "utilidad", "dependencia", "innovación"]
    },
    {
      prompt: "Describe un evento comunitario al que asististe",
      words: ["voluntariado", "asistencia", "organización", "sensibilización", "impacto"]
    },
    {
      prompt: "Comenta tu forma favorita de mantenerte activo",
      words: ["entrenamiento", "rutina", "motivación", "resistencia", "recuperación"]
    },
    {
      prompt: "Habla sobre una meta que lograste recientemente",
    ...
    {
      prompt: "Comenta cómo mantienes el equilibrio entre trabajo y vida",
      words: ["límites", "prioridades", "tiempo", "autocuidado", "flexibilidad"]
    },
    {
      prompt: "Habla sobre un invento que cambió el mundo",
    ...
    {
      prompt: "Comenta una tradición cultural que disfrutes",
      words: ["ritual", "celebración", "significado", "costumbres", "herencia"]
    },
    {
