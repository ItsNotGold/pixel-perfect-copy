...
print('Total tokens to check:', len(all_tokens))

# helper to verify non-placeholder entries
PLACEHOLDERS = [
...
if missing:
    print('Missing or placeholder entries:', len(missing))
    print(missing[:40])
else:
    print('All synonym tokens have non-empty, non-placeholder entries in all languages')
